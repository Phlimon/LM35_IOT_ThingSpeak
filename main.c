...
#define PORT				"80"
#define API_WRITE_KEY		"CHDGTB1D768XLFUW"			//"C7JFHZY54GLCJY38"
#define CHANNEL_ID			"981370"							//"119922"

#define SSID				"OrangeDSL-VPHLHF"//"AMIT-Learning"
#define PASSWORD			"PHLIMON_VERINA_20130547"
...
//		sprintf(_buffer, "GET /update?api_key=%s&field1=%d", API_WRITE_KEY, Local_u16Temp);
